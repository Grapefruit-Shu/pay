...
import com.xishanju.payment.utils.MD5Util;
...
public class PayCommonUtil {
    ...
    //请求方法
    public static String orderRequest(String requestUrl, String requestMethod, String outputStr) {
        try {
            ...
            logger.error("请求微信下单接口连接超时：{}"+ ce);
        } catch (Exception e) {
            logger.error("微信下单接口请求异常：{}"+ e);
        }
        return null;
    }
    //退款的请求方法
